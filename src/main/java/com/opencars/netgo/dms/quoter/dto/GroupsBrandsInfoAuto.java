...
public class GroupsBrandsInfoAuto implements Serializable {
    ...
    public GroupsBrandsInfoAuto() {
    }

    public GroupsBrandsInfoAuto(int id, boolean list_price, String name, boolean prices, int prices_from, int prices_to, String summary, int brand) {
        this.id = id;
