...
public class GroupsInfoAuto implements Serializable {
    ...
    public GroupsInfoAuto() {
    }

    public GroupsInfoAuto(int id, boolean list_price, String name, boolean prices, int prices_from, int prices_to, String summary) {
        this.id = id;
